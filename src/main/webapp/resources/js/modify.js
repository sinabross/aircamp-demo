...
$(document)
		.ready(
				function() {
					...
					$("button[type='submit']")
							.on(
									...
									function(e) {
										...
										/*
										 * var search_addr =
										 * $("#label_search").val().split(" ");
										 * 
										 * var a = search_addr[0]; var b =
										 * search_addr[1];
										 * 
										 * var searchAddress = a + " " + b; if
										 * ($("#label_search").val() ==
										 * "undifind") {
										 * $("#label_search").val(searchAddress); }
										 * 
					...
					// 카톡아이디
//					$("#katol").focusout(function() {
//						if (!mailJ.test($("#katol").val())) {
//							$("#i_katalk").text("이메일을 형식에 맞게 입력해 주세요");
//							$("i_katalk").addClass("red");
//							$("#i_katalk").addClass("mar");
//						} else {
//							$("#i_katalk").text("");
